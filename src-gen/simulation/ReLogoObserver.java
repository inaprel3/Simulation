...
public class ReLogoObserver extends BaseObserver{
	...
	/**
	 * Makes a number of randomly oriented users and then executes a set of commands on the
	 * created users.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<simulation.relogo.User> createUsers(int number, Closure closure) {
		AgentSet<simulation.relogo.User> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.crt(number,closure,"User");
	 ...
	 */
	@ReLogoBuilderGeneratedFor("simulation.relogo.User")
	public AgentSet<simulation.relogo.User> createUsers(int number) {
		return createUsers(number,null);
	}

	/**
	 * Makes a number of uniformly fanned users and then executes a set of commands on the
	 * created users.
	 * 
	 * @param number
	 *            a number
	 ...
	 */
	@ReLogoBuilderGeneratedFor("simulation.relogo.User")
	public AgentSet<simulation.relogo.User> createOrderedUsers(int number, Closure closure) {
		AgentSet<simulation.relogo.User> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.cro(number,closure,"User");
		for (Turtle t : createResult){
			if (t instanceof simulation.relogo.User){
				result.add((simulation.relogo.User)t);
			}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("simulation.relogo.User")
	public AgentSet<simulation.relogo.User> createOrderedUsers(int number) {
		return createOrderedUsers(number,null);
	}
	...
	public AgentSet<simulation.relogo.User> users(){
		...
		for (Object e : this.getContext().getObjects(simulation.relogo.User.class)) {
	...
	public AgentSet<simulation.relogo.User> usersOn(Patch p){
		...
		for (Turtle t : Utility.getTurtlesOnGridPoint(p.getGridLocation(),this,"user")){
			if (t instanceof simulation.relogo.User)
			result.add((simulation.relogo.User)t);
		}
		return result;
	...
	public AgentSet<simulation.relogo.User> usersOn(Turtle t){
		AgentSet<simulation.relogo.User> result = new AgentSet<simulation.relogo.User>();						
		for (Turtle tt : Utility.getTurtlesOnGridPoint(Utility.ndPointToGridPoint(t.getTurtleLocation()),this,"user")){
	...
	public AgentSet<simulation.relogo.UserTurtle> createUserTurtles(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("simulation.relogo.UserTurtle")
	public AgentSet<simulation.relogo.UserTurtle> createUserTurtles(int number) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("simulation.relogo.UserTurtle")
	public AgentSet<simulation.relogo.UserTurtle> createOrderedUserTurtles(int number, Closure closure) {
		AgentSet<simulation.relogo.UserTurtle> result = new AgentSet<>();
	 ...
	 */
	@ReLogoBuilderGeneratedFor("simulation.relogo.UserTurtle")
	public AgentSet<simulation.relogo.UserTurtle> createOrderedUserTurtles(int number) {
	...
	public AgentSet<simulation.relogo.UserTurtle> userTurtles(){
		...
		for (Object e : this.getContext().getObjects(simulation.relogo.UserTurtle.class)) {
	...
	public AgentSet<simulation.relogo.Registration> registrations(){
		...
		for (Object e : this.getContext().getObjects(simulation.relogo.Registration.class)) {
	...
	public simulation.relogo.Registration registration(Number oneEnd, Number otherEnd) {
		return (simulation.relogo.Registration)(this.getNetwork("Registration").getEdge(turtle(oneEnd),turtle(otherEnd)));
	}
	...
	public AgentSet<simulation.relogo.UserLink> userLinks(){
		...
		for (Object e : this.getContext().getObjects(simulation.relogo.UserLink.class)) {
	...
	public simulation.relogo.UserLink userLink(Number oneEnd, Number otherEnd) {
		return (simulation.relogo.UserLink)(this.getNetwork("UserLink").getEdge(turtle(oneEnd),turtle(otherEnd)));
	}
